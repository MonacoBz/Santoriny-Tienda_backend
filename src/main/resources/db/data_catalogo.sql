...
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'HI DOG',33.0,1,1,1);
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'DYNO ADULTO',23.0,1,1,1);
...
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'NUPEC CACHORRO',92.0,1,1,1);
...
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'DENTASTIX',9.0,6,1,2);
...
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'FELIX',60.0,1,2,1);
...
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'CAT CHOW ADULTO',62.0,1,2,1);
INSERT INTO producto(id_producto, activo, nombre, precio_x_unidad, id_categoria, id_tipo_alimento,id_unidad) VALUES (nextval('public.producto_seq_db'),true,'MININO',48.0,1,2,1);
